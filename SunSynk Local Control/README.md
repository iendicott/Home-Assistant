...
<br>You can provision a button to "Sync Now". To complete this in **Home Assistant \ Settings \ Device & Services \ Helpers**
<br>Click on **Create Helper**
<br>Scroll down to **Toggle** click on this and then name it **Sync Inverter Time**
<br>
