...
This project has been created to allow you to take local control over your SunSynk Inverter. It will give you the ability not only to read the inverter data but to set it from within Home Assistant. <br><br>
